...
//https://github.com/apache/accumulo-examples/blob/master/docs/helloworld.md
/*
...
public class HelloAccumulo {
    ...
    private static final Logger log = LoggerFactory.getLogger(HelloAccumulo.class);
    ...
    public static void main(String[] args)
        ...
        String filePath="/home/jouko/dev/software/accumulo-2.0.0-alpha-2/conf/accumulo-client.properties";
        try (AccumuloClient client = Accumulo.newClient().from(filePath).build()) {
